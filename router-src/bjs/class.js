function NiceScroll(a) {
    ...
    "function" != typeof this.init && (NiceScroll.prototype.init = function() {
        ...
        var a = $(this.ta).offset(), b = this.ta.offsetWidth, d = this.ta.offsetHeight - this.sbStyle.mTop, e = this.ta.scrollHeight - this.sbStyle.mTop, f = parseFloat(getNodeDefaultView(this.ta, "borderTopWidth")) || 0, g = parseFloat(getNodeDefaultView(this.ta, "borderBottomWidth")) || 0, h = parseFloat(getNodeDefaultView(this.ta, "borderRightWidth")) || 0;
        parseFloat(getNodeDefaultView(this.ta, "borderLeftWidth"));
        this.scH = e - d + f + g;
        this.stH = parseInt(.7 * (d / e) * d);
        ...
        0 >= e - d ? (setStyle(this.sb, {
            ...
            top: a.top + f + this.sbStyle.mTop,
            left: a.left - this.sbStyle.mLeft + b - h - parseInt(this.sb.offsetWidth)
        }), setStyle(this.st, {
        ...
        function a(b) {
            b = b || window.event;
            var c = b.touches[0].clientY, g = c - d.mousePos.y, g = parseFloat(d.st.style.top) - g, g = g >= d.sbcH ? d.sbcH : 0 >= g ? 0 : g;
            d.st.style.top = g + "px";
            d.mousePos.y = c;
            d.isScroll = !0;
            d.ta.scrollTop = d.scH * (g / d.sbcH);
        ...
        var d = this;
        document.attachEvent ? (this.ta.attachEvent("onmousewheel", function(a) {
            a = a || window.event;
            d._scroll(a);
            a.cancelBubble = !0;
            ...
            d._scroll(a);
            a.cancelBubble = !0;
        })) : (this.ta.addEventListener("mousewheel", function(a) {
            a = a || window.event;
            d._scroll(a);
            a.stopPropagation();
        }, !1), this.ta.addEventListener("DOMMouseScroll", function(a) {
            a = a || window.event;
            d._scroll(a);
            a.stopPropagation();
        }, !1), this.sb.addEventListener("mousewheel", function(a) {
            a = a || window.event;
            d._scroll(a);
            a.stopPropagation();
        }, !1), this.sb.addEventListener("DOMMouseScroll", function(a) {
            a = a || window.event;
            d._scroll(a);
            a.stopPropagation();
        }, !1));
        ...
        this.st.onmousedown = function(a) {
            ...
            document.onmousemove = function(a) {
                var b = getMousePos(a), c = b.y - d.mousePos.y, c = parseFloat(d.st.style.top) + c, c = c >= d.sbcH ? d.sbcH : 0 >= c ? 0 : c;
                d.st.style.top = c + "px";
                d.mousePos.y = b.y;
        ...
        null == id(this.taId) ? (window.clearTimeout(this.checkTt), this.sb.parentNode.removeChild(this.sb)) : !1 != this.enabled && (!1 == checkInHorize(this.ta) ? this.sb.style.display = "none" : (this.sb.style.display = "block", 
        0 >= parseInt(this.ta.offsetHeight) && (this.sb.style.visibility = "hidden"), this._reset()));
        ...
        if (0 > b.wtCounter) clearTimeout(b.wtId), b.wtId = null, !1 == b.onSb && (b.isScroll = !1); else {
        ...
        var d = !1;
        this.wtId ? (this.wtCounter = (d = 0 > (this.woSpeed ^ a)) ? b : 50 > this.wtCounter + b ? this.wtCounter + b : 50, 
        this.wSpeed = d ? a : 1.05 * this.wSpeed) : (this.wtCounter = b, this.woSpeed = this.wSpeed = a, 
...
function DateControl(a, c) {
    ...
    this.cellPadding = 1;
    void 0 == DateControl.prototype.init && (DateControl.prototype.hourStr = label.lHour, 
    DateControl.prototype.weekDayNum = 7, DateControl.prototype.lineStr = "-", DateControl.prototype.selTag = "selTag", 
    DateControl.prototype.cellBorderWidth = 1, DateControl.prototype.iCellIndex = 0, 
    DateControl.prototype.weekArray = [ label.Mon, label.Tue, label.Wen, label.Thu, label.Fri, label.Sta, label.Sun ], 
    DateControl.prototype._init = function() {
        ...
        var c, e, f, g = this.iCellIndex;
        if (!1 != a instanceof Array && void 0 != a && a.length == this.weekDayNum) for (var h = 0; h < this.weekDayNum; h++) {
            e = this.table.rows[h];
            c = a[h];
            for (var k = 0; 24 > k; k++) f = e.cells[k], f = f.childNodes[g], void 0 != c ? (this._setSel(f, c % 2), 
            c >>= 1) : this._setSel(f, 0);
        }
    }, DateControl.prototype._initOptions = function() {
        for (var a in c) "undefined" != typeof this[a] && (this[a] = c[a]);
    }, DateControl.prototype.getSelDate = function() {
        var a, c, e = this.weekDayNum, f = this.table.rows;
        this.selDate = [ 0, 0, 0, 0, 0, 0, 0 ];
        for (var g = 0; g < e; g++) {
            c = f[g];
            for (var h = 0; 24 > h; h++) a = c.cells[h], a = a.childNodes[0], a = parseInt(a.getAttribute("sel")), 
        ...
        var a = document.createElement("ul"), c, e, f = this;
        a.className = "hourList";
        for (var g = 0; 24 >= g; g++) c = document.createElement("li"), 24 != g ? (e = document.createElement("span"), 
        e.innerHTML = g, c.appendChild(e), c.style.width = this.cellWidth + 2 * this.cellPadding + this.cellBorderWidth + "px", 
        e.onclick = function(a) {
            return function() {
                for (var b = f.table.rows, c = b.length, d = f.iCellIndex, e = 1, g = 0; g < c && (e &= parseInt(b[g].cells[a].childNodes[d].getAttribute("sel")), 
                0 != e); g++) ;
                e = 1 - e;
                for (g = 0; g < c; g++) f._setSel(b[g].cells[a].childNodes[d], e);
                clearSelection();
            };
        }(g)) : (c.style.color = "#6EBFD9", c.innerHTML = this.hourStr), a.appendChild(c);
        this.dateCon.appendChild(a);
        this.hourList = a;
    }, DateControl.prototype._weekListInit = function() {
        var a = document.createElement("ul"), c, e = this;
        a.className = "weekList";
        for (var f = 0, g = this.weekDayNum; f < g; f++) c = document.createElement("li"), 
        c.style.height = this.cellHeight + 2 * this.cellPadding + this.cellBorderWidth + "px", 
        c.style.lineHeight = this.cellHeight + 2 * this.cellPadding + this.cellBorderWidth + "px", 
        c.innerHTML = this.weekArray[f], c.onclick = function(a) {
            return function() {
                for (var b = e.table.rows[a].cells, c = e.iCellIndex, d = 1, f = 0, g = b.length; f < g && (d &= parseInt(b[f].childNodes[c].getAttribute("sel")), 
                0 != d); f++) ;
                d = 1 - d;
                f = 0;
        ...
        for (var a, c, e, f, g = this, h = 0, k = this.weekDayNum; h < k; h++) {
            ...
            for (var l = 0; 24 > l; l++) e = c.insertCell(-1), e.style.padding = this.cellPadding + "px", 
            e.className = "weekTd", f = document.createElement("i"), f.className = "tableICell", 
            f.style.height = this.cellHeight + "px", f.style.width = this.cellWidth + "px", 
            e.appendChild(f), this._setSel(f, 0), void 0 != a ? (this._setSel(f, a % 2), a >>= 1) : this._setSel(f, 0), 
...
function PageFunc() {
    ...
    this.detectPathStr = "/web-static/images/nothing.png?random=20190225200722";
    this.imgDetectPathStr = "./web-static/images/logo.png?random=20190225200722";
    this.loginId = "Login";
    this.coverId = "Cover";
    ...
    this.loadPageHandleBg = function() {
        for (var a = $("i.helpBtn"), c, b, d = 0, e = a.length; d < e; d++) b = a[d], c = b.getAttribute(helpIdStr), 
        b = b.getAttribute(helpTopClassStr), null != c && helpBind(a[d], c, b);
    };
    ...
    this.showCon = function(a) {
        var c = id(a), b, d = document.body.childNodes, e;
    ...
    this.loginChange = function(a) {
        ...
        var b = this.id(this.loginId), d = "block", e = "none", f, g = document.body.childNodes, h = this;
        ...
        !0 == a ? (a = $.authRltObj.code, ESYSRESET == a ? (!0 == OS.portable && !1 == OS.iPad ? loadLgLessPage("PhoneSetPwd.htm", "Con", void 0, {
            ...
            bRecordLoadPage: !1
        })), emptyNodes(id("Con")), setLoadPage("Content.htm", "Con")) : ESYSLOCKEDFOREVER == a || ESYSLOCKED == a ? (document.body.style.height = "auto", 
        $.queryAuthLog(function(a) {
            ...
            bRecordLoadPage: !1
        }))) : (document.body.style.height = !0 == OS.portable && !1 == OS.iPad && !1 == phoneSet.bContinuePCSet ? "100%" : _gPageHeightLg + "px", 
        this.loadPageData.options = this.loadPageData.options || {}, this.loadPageData.options.bRecordLoadPage = !1, 
    ...
    this.localSgInit = function() {
        try {
            this.sessionLS.init(), !0 == isIE && !1 == isIENormal && function() {
    ...
    this.iFrmOnload = function(a, c, b) {
        ...
        try {
            ...
            /(<pre>)?(.+)(<\/pre>)+/.test(d) || /(<pre>)?(.+)/.test(d), e = JSON.parse(d), b = e[ERR_CODE], 
            b != ENONE && closeProgBar(), c(b, e);
        } catch (f) {
    ...
    this.cloneLocalMac = function() {
        var a = $.readEx(SYSTEM_DATA_ID), c = this.getCurrPcMac(), b = ENONE;
    ...
    this.pageOnload = function() {
        var a = [ {
            tag: "link",
            url: "../web-static/dynaform/DataGrid.css?random=20190225200722"
        } ], c = [ {
            tag: "script",
            url: "../web-static/dynaform/DataGrid.js?random=20190225200722"
        }, {
            tag: "script",
            url: "../web-static/dynaform/menu.js?random=20190225200722"
        } ], b = [ {
            tag: "script",
            url: "../web-static/lib/jsencrypt.js?random=20190225200722"
        }, {
            tag: "script",
            url: "../web-static/lib/slp-ajax.js?random=20190225200722"
        }, {
            tag: "script",
            url: "../web-static/lib/ajax.js?random=20190225200722"
        }, {
            tag: "script",
            url: "../web-static/dynaform/uci.js?random=20190225200722"
        }, {
            tag: "script",
            url: "../web-static/language/cn/str.js?random=20190225200722"
        }, {
            tag: "script",
            url: "../web-static/language/cn/error.js?random=20190225200722"
        }, {
            tag: "script",
            url: "../web-static/lib/verify.js?random=20190225200722"
        }, {
            tag: "script",
            url: "../web-static/dynaform/macFactory.js?random=20190225200722"
        } ];
        this.loadExternResource({
            scripts: [ {
                tag: "script",
                url: "../web-static/lib/jquery-1.10.1.min.js?random=20190225200722"
            }, {
                tag: "script",
                url: "../web-static/lib/json.js?random=20190225200722"
            } ],
            callBack: function() {
                this.loadExternResource({
                    scripts: b,
                    callBack: function() {
                        ...
                        this.compatibleShow();
                        this.localSgInit();
                        !0 == $.local ? this.loadPage("Content.htm", "Con") : !1 == /^((http:\/\/)*(\d{1,3}\.){3}\d{1,3})/g.test(b) && 0 <= b.indexOf(gDomainDNS) ? $.sendAjaxReq("/", {
                            get_domain_array: "null",
                            method: "do"
                        }, function(a) {
                            ENONE == a[ERR_CODE] ? (a = a.domain_array, 1 < a.length ? (this.gDomainDetectArr = a, 
                            this.loadLgLessPage("RouterSelect.htm", "Con", void 0, {
                                bRecordLoadPage: !1
                            })) : this.loadPage("Content.htm", "Con")) : this.loadPage("Content.htm", "Con");
                        }, !0, "json") : this.loadPage("Content.htm", "Con");
                    }
                });
            }
        });
    ...
    this.loadExternResource = function(a) {
        ...
        b = c.scripts;
        d = c.callBack;
        if (void 0 != a) for (var h in a) c = document.createElement("link"), c.rel = "stylesheet", 
        c.href = a[h].url, f.appendChild(c);
        if (void 0 != b) {
            var k;
            ...
            for (h in b) c = document.createElement("script"), c.type = "text/javascript", void 0 != d && (e ? c.onreadystatechange = function(a) {
                return function() {
                    if ("loaded" == this.readyState || "complete" == this.readyState) this.onreadystatechange = null, 
                    k(a);
                };
...
function Style() {
    ...
    this.getNodeDefaultView = function(a, c) {
        ...
        if (!a) return null;
        try {
            return b = a.currentStyle ? a.currentStyle : document.defaultView.getComputedStyle(a, null), 
            void 0 != c ? b[c] : b;
        } catch (d) {}
    };
}
    ...
    try {
        this.sessionLS = null == this.sessionStorage ? {
            ...
            setExpire: function(a) {
                var b = new Date(), b = new Date(b.getTime() + a);
                this.dom.load(this.file_name);
...
function Explorer() {
    ...
    this.getIEInfo = function() {
        ...
        !1 != isIE && (6 >= isIE ? this.isIESix = !0 : 7 == isIE ? this.isIESeven = !0 : 9 <= isIE && (this.isIENormal = !0), 
        10 >= isIE && (this.isIETenLess = !0), this.isIE = !0);
    };
    this.compatibleShow = function() {
        if (!0 == this.isIESix) {
            var a, c, b, d, e;
            0 <= document.cookie.indexOf("ieSixClosed") || (a = $("div.ieSixCompatible"), void 0 == a[0] && (a = el("div"), 
            a.className = "ieSixCompatible", c = el("div"), c.className = "ieSixCpCon", b = el("i"), 
            d = el("span"), d.className = "spanNote", d.innerHTML = label.IESixCpTip, e = el("span"), 
            e.className = "spanClose", e.innerHTML = label.iknown, e.onclick = function() {
    ...
    this.createGroupRadio = function(a) {
        ...
        !0 == this.isIE && !1 == this.isIENormal ? c = document.createElement("<input name='" + a + "' />") : (c = document.createElement("input"), 
        c.name = a);
        return c;
    };
    this.getIEInfo();
...
function Tool() {
    ...
    this.replaceJSP = function(a) {
        var c = null, b, d = /{%(\w+)\.(\w+)%}/i, c = d.exec(a);
        try {
            for (;null != c; ) b = language[c[1]][c[2]], a = a.replace("{%" + c[1] + "." + c[2] + "%}", b), 
            c = d.exec(a);
        } catch (e) {}
        try {
    ...
    this.setDomCursorPos = function(a, c) {
        if (a.setSelectionRange) a.focus(), a.setSelectionRange(c, c); else if (a.createTextRange) {
    ...
    this.getChildNode = function(a, c, b) {
        ...
        f = c.split(" ");
        c = f[0];
        for (var g = f[1], h = 0, k = a.length; h < k; h++) f = a[h], 1 == f.nodeType && f.tagName.toLowerCase() == c && (void 0 != g && f.type == g ? (d[e] = f, 
        e++) : void 0 == g && (d[e] = f, e++));
    ...
    this.setUrlHash = function(a, c) {
        ...
        var f = location.href;
        d = location.hash;
        void 0 != a && void 0 != c && 0 != a.length && (0 != d.length ? (e = d.indexOf(a), 
        0 <= e ? (b = d.substring(0, e), d = d.substring(e), e = d.indexOf("#"), 0 < e ? (d = d.substring(e), 
        d = b + a + "=" + c + d) : d = b + a + "=" + c) : ("#" != d.substring(d.length - 1) && (b = "#"), 
        d += b + a + "=" + c), location.href = f.substring(0, f.indexOf("#")) + d) : f.lastIndexOf("#") == f.length - 1 ? location.href += a + "=" + c : location.href += "#" + a + "=" + c);
    };
    this.getUrlHash = function(a) {
        var c = location.hash, b, d = "";
        if (0 < c.indexOf(a)) {
            var c = c.substring(1).split("#"), e;
    ...
    this.changeUrlHash = function(a) {
        var c = location.href, b = c.indexOf("#");
    ...
    this.getStrInMax = function(a, c) {
        var b = "", d, e = 0;
        d = a.replace(/[A-Zmw]/g, "xx");
        d = getDisplayStrLen(d);
        if (d <= c) return a;
        var f = a.substring(0, a.length - 1), g = f.replace(/[A-Zmw]/g, "xx");
        if (getDisplayStrLen(g) < c && d > c) return f + "...";
        for (f = 1; f <= c; f++) {
            d = a.charAt(e);
            if ("" == d) break;
            1 < getDisplayStrLen(d) ? (f += getDisplayStrLen(d) - 1, b += d, beCut = !0) : !0 == /[A-Zmw]/g.test(d) ? (f++, 
            b += d, beCut = !0) : b += d;
            e++;
        }
        return b + "...";
    ...
    this.securityEncode = function(a, c, b) {
        ...
        h = b.length;
        e = f > g ? f : g;
        for (var m = 0; m < e; m++) l = k = 187, m >= f ? l = c.charCodeAt(m) : m >= g ? k = a.charCodeAt(m) : (k = a.charCodeAt(m), 
        l = c.charCodeAt(m)), d += b.charAt((k ^ l) % h);
        return d;
    };
    this.simulateMouseC = function(a) {
        simulateMouseC = !0 == isIE && !1 == isIENormal ? function(a) {
    ...
    this.compareObj = function(a, c) {
        ...
        } else return !1; else if (a[d] != c[d]) return !1;
        return b;
    };
    this.replaceUnicodeBlank = function(a) {
        if (void 0 != a && void 0 != a.value) {
            var c = a.value, b = c.replace(/[\u2000\u2001\u2002\u2003\u2004\u2005\u2006\u2007\u2008\u2009\u200a\u200b\u2028\u2029\u3000]/gi, " ");
            c !== b && (a.value = b);
            return b;
        }
    };
...
function Switch(a, c, b) {
    ...
    "function" != typeof Switch.prototype.switchInit && (Switch.prototype.switchInit = function() {
        var a = this.state, b = this.switchBall, c = this.switchCon, g = this.switchBg;
        null != c && null != b && (this.rightPos = c.offsetWidth - b.offsetWidth, this.setState(a), 
        this.callback && this.callback(a), b.onmousedown = this.draggableBind(), g.onclick = this.switchBgClick());
    }, Switch.prototype.setState = function(a) {
        var b = this.switchCon, c = this.switchBall;
        this.state = a;
        b.value = a;
        c.style.left = a * this.rightPos + "px";
        c.style.background = 1 == a ? "url(../web-static/images/routerBg.png?random=20190225200722) -441px -53px no-repeat" : "url(../web-static/images/routerBg.png?random=20190225200722) -424px -52px no-repeat";
        hsSwitchState(b.id, a);
    }, Switch.prototype.switchChgState = function(a) {
        a = 1 - a;
        this.setState(a);
        this.callback && this.callback(a);
    }, Switch.prototype.switchCHandle = function() {
        var a = this.state, b = this.switchBall, c = 1 == a ? -1 : 1, g = parseInt(b.style.left), h = this.rightPos, k = this;
        1 == a && 0 >= g || 0 == a && g >= h ? this.switchChgState(a) : (b.style.left = g + c * h / 8 + "px", 
        window.setTimeout(function() {
            k.switchCHandle();
        }, 20));
        ...
        return function(b) {
            b = b ? b : window.event;
            var c = getMousePos(b), g = b.target || b.srcElement, h = {
                x: c.x - g.offsetLeft
            };
...
function HighSet() {
    ...
    this.IMG_HS_LOADING_WHITE = "IMG_HS_LOADING_WHITE";
    this.hsLoadingObj = {
        subBtnId: "",
        handleLoad: "",
        handleDelayHd: null,
        ...
        loadImgCol: {
            IMG_HS_LOADING_GREEN: "hsLoadingGreen.gif?random=20190225200722",
            IMG_HS_LOADING_BLUE: "hsLoadingBlue.gif?random=20190225200722",
            IMG_HS_LOADING_RED: "hsLoadingRed.gif?random=20190225200722",
            IMG_HS_LOADING_WHITE: "hsLoadingWhite.gif?random=20190225200722",
            IMG_HS_LOADING_YELLOW: "hsLoadingYellow.gif?random=20190225200722"
        }
    };
    this.hsStatSet = function(a, c, b) {
        var d, e;
        void 0 == b ? (d = $("ul.gridStatus")[0], e = $("ul.gridStatus label")[0], statPic = $("ul.gridStatus i")[0]) : (d = $("#" + b)[0], 
        e = $("#" + b + " label")[0], statPic = $("#" + b + " i")[0]);
        switch (a) {
          case "null":
          ...
          case "correct":
            e.innerHTML = c;
            statPic.style.background = "url(../web-static/images/routerBg.png?random=20190225200722) -353px -122px no-repeat";
            d.style.visibility = "visible";
            break;

          case "error":
            e.innerHTML = c;
            statPic.style.background = "url(../web-static/images/routerBg.png?random=20190225200722) -306px -209px no-repeat";
            d.style.visibility = "visible";
            break;

          case "link":
            e.innerHTML = c;
            statPic.style.background = "url(../web-static/images/routerBg.png?random=20190225200722) -372px -123px no-repeat";
            d.style.visibility = "visible";
            break;

          case "exception":
            e.innerHTML = c;
            statPic.style.background = "url(../web-static/images/routerBg.png?random=20190225200722) -334px -123px no-repeat";
            d.style.visibility = "visible";
            break;
    ...
    this.disInputTip = function(a, c) {
        null != a && void 0 != c && ("error" == c.toLowerCase() ? this.setStyle(a, {
            visibility: "visible",
            background: "url(../../web-static/images/wzd.png?random=20190225200722) no-repeat -116px -243px"
        }) : "ok" == c.toLowerCase() ? this.setStyle(a, {
            visibility: "visible",
            background: "url(../../web-static/images/wzd.png?random=20190225200722) no-repeat -95px -243px"
        }) : "warn" == c.toLowerCase() ? this.setStyle(a, {
            visibility: "visible",
            background: "url(../../web-static/images/wzd.png?random=20190225200722) no-repeat -137px -243px"
        }) : a.style.visibility = "hidden");
    };
    ...
    this.disableBtn = function(a, c) {
        var b = "object" == typeof a ? a : id(a), d = b.className;
    ...
    this.disableClick = function(a, c, b) {
        ...
        if (!0 == c) return 0 >= a.disableTimes && (a.oldOnClick = a.onclick, a.onclick = null), 
        b = a.oldOnClick, a.disableTimes++, b;
        a.disableTimes--;
    ...
    this.hsLoading = function(a, c) {
        var b = this.hsLoadingObj, d = id(b.subBtnId), e, f, g, h, k, l, m;
        null != d && d == b.subBtnObj && (k = d.parentNode, k.style.position = "relative", 
        h = d.offsetWidth, e = d.offsetLeft, g = d.offsetTop, f = d.offsetHeight, m = $("#" + b.subBtnId + " ~ div.hsLoadingCon")[0], 
        l = $("#" + b.subBtnId + " ~ div.hsLoadingCon img")[0], window.clearTimeout(b.handleDelayHd), 
        !0 == a ? ($("#" + b.subBtnId).css("visibility", "hidden"), void 0 == m ? (m = el("div"), 
        m.className = "hsLoadingCon", k.appendChild(m), m.style.width = h + "px", m.style.height = f + "px", 
        m.style.top = g + "px", m.style.left = e + "px", l = el("img"), m.appendChild(l), 
        l.onload = function() {
            l.style.height = f + "px";
            m.style.visibility = "visible";
        }, l.src = "../web-static/images/" + b.loadImgCol[b.loadImgKey]) : (l.style.height = f + "px", 
        m.style.height = f + "px", m.style.width = h + "px", m.style.top = g + "px", m.style.left = e + "px", 
        m.style.visibility = "visible")) : b.handleDelayHd = window.setTimeout(function() {
            b.subBtnId = "";
            d.style.visibility = "visible";
            void 0 != m && (m.style.visibility = "hidden");
            "function" == typeof c && c();
        }, 500));
    };
    this.hsSwitchState = function(a, c) {
        var b = $("#" + a + " ~ span.hsSwitchState")[0];
        null != b && (1 == c ? (b.innerHTML = statusStr.opened, b.style.color = "#86B157") : (b.innerHTML = statusStr.closed, 
        b.style.color = "#FB6E52"));
    };
}
...
function Basic() {
    ...
    this.gSetLoadAppDetail = function(a, c) {
        this.gLoadAppDetail.appId = void 0 == a ? this.gLoadAppDetail.appId : a;
        this.gLoadAppDetail.uri = void 0 == c ? this.gLoadAppDetail.uri : c;
        "" !== a && "" !== c && this.setBasicSubMenuUrl("AppsInstalled.htm");
    };
    this.gBasicMenu = {
...
function ShowTips() {
    ...
    this.showAlert = function(a, c, b, d) {
        this.showCover(function() {
            var e = id("Error"), f = id("hsErr"), g, h = this;
            !0 == isIESix ? alert(a) : (this.shAltObjOrId = c, g = $("div.hsTip input.subBtn")[0], 
            null == f && (f = document.createElement("div"), f.id = "hsErr", f.className = "hsTip", 
            g = document.createElement("p"), g.className = "detail", f.appendChild(g), g = document.createElement("input"), 
            g.type = "button", g.className = "subBtn ok", g.value = btn.ok, f.appendChild(g), 
            e.appendChild(f)), getChildNode(f, "p").innerHTML = a, b && (f.style.marginLeft = "280px"), 
            g.onclick = function() {
                "function" == typeof d && d();
                h.closeAlert(!0);
            }, e.style.visibility = "visible", e.style.display = "block", e.style.top = "90px", 
            !1 == OS.portable ? setStyle(e, {
                position: "fixed"
            }) : setStyle(e, {
                position: "absolute"
    ...
    this.closeAlert = function(a) {
        this.hideCover(function() {
            var c = id("Error"), b = this.shAltObjOrId;
            if (null != c) if (c.style.top = "-9999px", c.style.visibility = "hidden", clearTimeout(this.alertTimeHd), 
            this.alertTimeHd = null, !0 != a || void 0 == b || "object" != typeof b && 0 == b.length) this.shAltObjOrId = ""; else try {
    ...
    this.showAlertC = function(a, c, b, d) {
        this.showCover(function() {
            ...
            !0 == isIESix ? alert(a) : (this.shAltObjOrId = c, g = $("div.hsTip input.subBtn")[0], 
            null == f && (f = document.createElement("div"), f.id = "hsErr", f.className = "hsTip", 
            g = document.createElement("i"), g.className = "alertImg", f.appendChild(g), g = document.createElement("p"), 
            g.className = "detailImg", f.appendChild(g), g = document.createElement("input"), 
            g.type = "button", g.className = "subBtn ok", g.value = btn.ok, f.appendChild(g), 
            e.appendChild(f)), getChildNode(f, "p").innerHTML = a, b && (f.style.marginLeft = "280px"), 
            g.onclick = function() {
                d && d();
    ...
    this.showConfirm = function(a, c, b, d) {
        this.showCover(function() {
            var e = id("Confirm"), f = id("hsConf"), g, h = this, k = void 0 != b ? b : btn.ok, l = void 0 != d ? d : btn.cancel;
            !0 == isIESix ? (e = confirm(a), this.closeConfirm(), c(e)) : (null == f && (f = document.createElement("div"), 
            f.id = "hsConf", f.className = "hsTip", g = document.createElement("p"), g.className = "detail", 
            f.appendChild(g), g = document.createElement("input"), g.type = "button", g.className = "subBtn ok", 
            g.value = k, f.appendChild(g), g = document.createElement("input"), g.type = "button", 
            g.className = "subBtn cancel", g.value = l, f.appendChild(g), e.appendChild(f)), 
            g = $("#hsConf input"), g[0].value = k, g[0].onclick = function() {
                h.closeConfirm();
                c(!0);
            }, g[1].value = l, g[1].onclick = function() {
                h.closeConfirm();
                c(!1);
            }, getChildNode(f, "p").innerHTML = a, e.style.visibility = "visible", e.style.display = "block", 
            e.style.top = "90px", !1 == OS.portable ? setStyle(e, {
                position: "fixed"
            }) : setStyle(e, {
                position: "absolute"
            }));
    ...
    this.showConfirmB = function(a, c) {
        this.showCover(function() {
            var b = id("Confirm"), d = id("hsConf"), e, f = this;
            !0 == isIESix ? (b = confirm(a), this.closeConfirm(), c(b)) : (null == d && (d = document.createElement("div"), 
            d.id = "hsConf", d.className = "hsTip", e = document.createElement("i"), e.className = "confirmImg", 
            d.appendChild(e), e = document.createElement("p"), e.className = "detailImg", d.appendChild(e), 
            e = document.createElement("input"), e.type = "button", e.className = "subBtn ok", 
            e.value = btn.cloudRetry, d.appendChild(e), e = document.createElement("input"), 
            e.type = "button", e.className = "subBtn cancel", e.value = btn.cloudBack, d.appendChild(e), 
            b.appendChild(d)), e = $("#hsConf input"), e[0].onclick = function() {
                f.closeConfirm();
                c(!0);
            }, e[1].onclick = function() {
                f.closeConfirm();
                c(!1);
            }, getChildNode(d, "p").innerHTML = a, b.style.visibility = "visible", b.style.display = "block", 
            b.style.top = "90px", !1 == OS.portable ? setStyle(b, {
                position: "fixed"
            }) : setStyle(b, {
                position: "absolute"
            }));
    ...
    this.showWzdConfirmB = function(a, c, b, d) {
        this.showCover(function() {
            var e = id("Confirm"), f = id("hsConf"), g, h = this, k = void 0 != b ? b : btn.ok, l = void 0 != d ? d : btn.cancel;
            !0 == isIESix ? (e = confirm(a), this.closeConfirm(), c(e)) : (null == f && (f = document.createElement("div"), 
            f.id = "hsConf", f.className = "hsTip hsTipWzd", g = document.createElement("p"), 
            g.className = "detail detailWzd", f.appendChild(g), g = document.createElement("input"), 
            g.type = "button", g.className = "subBtn ok", g.value = k, f.appendChild(g), g = document.createElement("input"), 
            g.type = "button", g.className = "subBtn cancel", g.value = l, f.appendChild(g), 
            e.appendChild(f)), g = $("#hsConf input"), g[0].value = k, g[0].onclick = function() {
                h.closeWzdConfirmB();
                c(!0);
            }, g[1].value = l, g[1].onclick = function() {
                h.closeWzdConfirmB();
    ...
    this.closeWzdConfirmB = function() {
        this.hideCover(function() {
            var a = id("Confirm"), c = id("hsConf");
            c.parentNode.removeChild(c);
            null != a && (a.style.top = "-9999px", a.style.visibility = "hidden");
        });
    };
    this.showConfirmChoice = function(a, c, b, d) {
        this.showCover(function() {
            var e = id("ConfirmCh"), f = id("hsConfCh"), g, h, k = this, l = void 0 != b ? b : btn.ok, m = void 0 != d ? d : btn.cancel;
            !0 == isIESix ? (e = confirm(a), this.closeConfirm(), c(e)) : (null == e && (e = document.createElement("div"), 
            e.id = "ConfirmCh", document.body.appendChild(e)), null == f && (f = document.createElement("div"), 
            f.id = "hsConfCh", f.className = "hsTip hsTipCh", g = document.createElement("p"), 
            g.className = "cancel", h = document.createElement("i"), h.className = "cancelImg", 
            g.appendChild(h), f.appendChild(g), g = document.createElement("p"), g.className = "detail detailCh", 
            f.appendChild(g), g = document.createElement("input"), g.type = "button", g.className = "subBtn ok", 
            g.value = l, f.appendChild(g), g = document.createElement("input"), g.type = "button", 
            g.className = "subBtn ok", g.value = m, f.appendChild(g), e.appendChild(f)), g = $("#hsConfCh p"), 
            g[0].firstChild.onclick = function() {
                k.closeConfirmChoice();
                c();
            }, f = $("#hsConfCh input"), f[0].value = l, f[0].onclick = function() {
                k.closeConfirmChoice();
                c(!0);
            }, f[1].value = m, f[1].onclick = function() {
                k.closeConfirmChoice();
                c(!1);
            }, g[1].innerHTML = a, e.style.visibility = "visible", e.style.display = "block", 
            e.style.top = "90px", !1 == OS.portable ? setStyle(e, {
                position: "fixed"
            }) : setStyle(e, {
                position: "absolute"
    ...
    this.showNote = function(a, c) {
        var b = id(a);
        void 0 != b && (void 0 != c && ($("#" + a + " div.noteCon p")[0].innerHTML = c), 
        b.style.visibility = "visible");
    };
    this.showNoteB = function(a, c, b) {
        var d = id(a), e;
        void 0 != d && (e = $("#" + a + " i.tip")[0], a = $("#" + a + " span")[0], void 0 != c && (a.innerHTML = c), 
        a.className = void 0 != b ? b : "note", e.style.visibility = "visible", d.style.visibility = "visible");
    };
    ...
    this.showLoading = function(a, c, b, d) {
        ...
        showCover(function(e) {
            ...
            e = $("#" + e.id);
            g = .7;
            void 0 != b && (f = b.loadConClass, h = b.loadClass, k = b.coverLoadingClass, l = b.detailClass, 
            g = b.coverOpacity || 0);
            e.css("opacity", g);
            g = el("div");
            ...
            e.appendChild(f);
            void 0 == k ? (h = el("img"), h.className = "coverLoading", h.src = "../web-static/images/loadingRouteSet.gif?random=20190225200722") : (h = el("i"), 
            h.className = k);
            f.appendChild(h);
            k = el("p");
            k.className = l || "coverLoadNote";
            k.innerHTML = void 0 == a ? label.checkingWait : a;
            f.appendChild(k);
            d = void 0 == d ? !0 : d;
            !0 == d && (l = el("input"), l.type = "button", l.className = "coverLoadClose cancelBtn", 
            l.value = btn.cancel, l.onclick = function() {
                closeLoading(c);
            }, f.appendChild(l));
        });
    };
    this.closeLoading = function(a) {
        ...
        null != c && ($("#" + this.CoverId).css("opacity", ""), document.body.removeChild(c), 
        hideCover(a));
    };
    this.showPhWzdAlert = function(a, c) {
        this.showCover(function() {
            var b, d, e, f = this;
            b = id("phWzdAlertCon");
            null == b ? (b = document.createElement("div"), b.className = "phWzdAlertCon", b.id = "phWzdAlertCon", 
            document.body.appendChild(b), d = document.createElement("img"), d.src = "../web-static/images/redWarn.png?random=20190225200722", 
            b.appendChild(d), d = document.createElement("p"), b.appendChild(d), e = document.createElement("label"), 
            e.className = "btnAlert", b.appendChild(e), e.innerHTML = btn.confirm) : (d = $("#phWzdAlertCon p")[0], 
    ...
    this.showPhConfirm = function(a, c, b, d) {
        this.showCover(function() {
            var e, f, g, h, k = this, l = void 0 != b ? b : btn.ok, m = void 0 != d ? d : btn.cancel;
            e = id("phConfirmCon");
            null == e ? (e = document.createElement("div"), e.className = "phWzdAlertCon", e.id = "phConfirmCon", 
            document.body.appendChild(e), f = document.createElement("img"), f.src = "../web-static/images/redWarn.png?random=20190225200722", 
            e.appendChild(f), f = document.createElement("p"), e.appendChild(f), h = document.createElement("label"), 
            h.className = "btnN", e.appendChild(h), g = document.createElement("label"), g.className = "btnY", 
            e.appendChild(g)) : (f = $("#phConfirmCon p")[0], h = $("#phConfirmCon label")[0], 
            g = $("#phConfirmCon label")[1]);
            f.innerHTML = a;
            h.innerHTML = m;
            g.innerHTML = l;
            e.style.top = "120px";
...
function Select() {
    this.selectInitExtern = function(a, c, b, d, e, f) {
    ...
    this.selectInit = function(a, c, b, d, e, f, g) {
        function h(a) {
            for (var b, c, d = a.childNodes, e = 0, f = d.length; e < f; e++) c = d[e], b = c.childNodes[0].style.visibility, 
            c.style.backgroundColor = "visible" == b ? x : z, c.style.color = "visible" == b ? y : r;
            a.style.visibility = "hidden";
            a.style.top = "-9999px";
            a.parentNode.style.position = "static";
        }
        function k(b) {
            var c = id(a), e = b.parentNode, f = e.childNodes, g = $("#" + a + " span.value")[0];
            if (3 != b.childNodes[0].nodeType) {
                c.value = b.valueStr;
                g.value = b.valueStr;
                for (var h = 0, k = f.length; h < k; h++) f[h].childNodes[0].style.visibility = "hidden", 
                f[h].style.backgroundColor = z, f[h].style.color = r;
        ...
        function l(a) {
            for (var b = 0, c = a.length; b < c; b++) q = a[b], D = htmlEscape(getStrInMax(q.str.toString(), H)), 
            v = "hidden", n = document.createElement("li"), void 0 == q.value && b == B || B == q.value ? (v = "visible", 
            s.innerHTML = D, s.value = B, t.value = B, n.style.backgroundColor = x, n.style.color = y, 
            n.innerHTML = "<span class='selCross' style='visibility:" + v + "'></span>" + D) : (n.style.color = r, 
            n.innerHTML = "<span class='selCrossOut' style='visibility:" + v + "'></span>" + D), 
            n.title = q.str, n.valueStr = void 0 != q.value ? q.value : b, n.className = "option", 
            n.onclick = function(a) {
                ...
                if ("span" != a.tagName.toLowerCase()) {
                    ...
                    for (var d = 0, e = b.length; d < e; d++) c = b[d], c.style.backgroundColor = z, 
                    c.style.color = r, c = getChildNode(c, "span"), c.className = "selCrossOut";
        ...
        function m(b) {
            function c(a) {
                a && (e.each(function() {
                    "visible" == this.style.visibility && h(this);
                    return !0;
                }), d.css("visibility", "visible").css("top", "-1px"), d[0].parentNode.style.position = "relative", 
                stopProp(b));
            }
            var d = $("#" + u + a), e = $("ul." + u);
            "undefined" != typeof g ? g(c) : c(!0);
        }
        var n, q, s, v = "hidden", w = document.createElement("ul"), t = id(a), u = "selOptsUl", z = "#FFFFFF", x = "#2BA2D8", r = "#3C3E43", y = "#FFFFFF", C = "#FFFFFF", I = "#B2B2B2", A, H, J, D, B = b;
        b = "#34A9DA";
        var E = 1001, F = 3, G = 3;
        void 0 != f && (u = f.className, z = f.colorN, x = f.colorC, r = f.fontColorN, y = f.fontColorC, 
        C = f.valueColor, I = f.valueDisColor, b = void 0 == f.scrollBg ? b : f.scrollBg, 
        E = void 0 == f.scrollZIndex ? E : f.scrollZIndex, F = void 0 == f.scrollMLeft ? F : f.scrollMLeft, 
        G = void 0 == f.scrollMTop ? G : f.scrollMTop);
        f = t.parentNode;
        A = $("#" + a + " span.value");
        s = A[0];
        s.value = 0;
        J = parseInt(A.css("width"));
        A = (.61 * parseInt(A.css("fontSize"))).toFixed(1);
        H = void 0 == e ? parseInt(J / A) : e;
        t.value = 0;
        w.className = u;
        w.id = u + a;
        f.appendChild(w);
        ...
        t.disable = function(a) {
            t.onclick = !0 == a ? null : m;
            s.style.color = !0 == a ? I : C;
        };
        t.changeSel = function(b) {
            $("#" + u + a + " li");
            $("#" + u + a + " li").each(function() {
                if (this.valueStr == b) return k(this), !1;
            });
        };
        t.resetOptions = function(a, b) {
            w.innerHTML = "";
            B = b || 0;
            l(a);
        };
        c = new NiceScroll(w.id);
...
function Help() {
    ...
    this.helpInit = function() {
        var a = id(this.help), b, d, e = this;
        0 == a.innerHTML.length && (b = document.createElement("p"), b.className = "helpTop", 
        b.onmousedown = this.draggableBind(this.help), a.appendChild(b), d = document.createElement("span"), 
        d.className = "helpDes", d.innerHTML = label.help, b.appendChild(d), d = document.createElement("i"), 
        d.onclick = function() {
            e.helpClose();
        }, d.className = "helpClose", b.appendChild(d), b = document.createElement("div"), 
        b.id = "helpDetail", a.appendChild(b), b = document.createElement("div"), b.style.display = "none", 
        b.id = this.helpContent, document.body.appendChild(b));
        loadPage(this.helpURL, this.helpContent);
    };
    this.touchMoveHd = function(c) {
        c = c || window.event;
        var b = c.touches[0].clientX, d = c.touches[0].clientY, e = id(a.help), b = b - a.mousePos.x, d = d - a.mousePos.y, f = document.body.clientWidth - e.offsetWidth, g = document.documentElement.scrollHeight - e.offsetHeight, b = 0 < b ? b : 0, d = 0 < d ? d : 0;
    ...
    this.helpClose = function() {
        var a = id(this.help), b = id(this.helpDetail);
    ...
    this.helpVisible = function(a) {
        var b = id(this.help), d = $(a).offset(), e = $("#basicContent").offset();
        setStyle(b, {
            visibility: "visible",
            top: e.top + "px",
    ...
    this.msMove = function(a, b, d) {
        ...
        var f = document.documentElement.scrollHeight - a.offsetHeight, e = 0 < e ? e : 0;
        b = 0 < b ? b : 0;
    ...
    this.basicAppUpgradeInfoShow = function(a, b, d) {
        var e = id("basicAppUpgradeInfo"), f, g;
        a = $(a);
        var h = a.offset();
        null == e && (e = document.createElement("div"), e.id = "basicAppUpgradeInfo", document.body.appendChild(e), 
        f = document.createElement("p"), f.className = "appsHelpTop", f.onmousedown = this.draggableBind(this.help), 
        e.appendChild(f), g = document.createElement("span"), g.className = "helpDes", g.innerHTML = label.updateNoteStr, 
        f.appendChild(g), g = document.createElement("i"), g.onclick = function() {
            e.style.display = "none";
            e.style.top = "-9999px";
        }, g.className = "helpClose", f.appendChild(g), f = document.createElement("div"), 
        f.id = "basicAppUpgradeInfoDetail", f.className = "basicAppUpgradeInfoDetail", e.appendChild(f), 
        f = new NiceScroll("basicAppUpgradeInfoDetail"), f.scrollTipOpacity(1), f.scrollTipSet({
            background: "#B0CB33"
        }), f.scrollBarSet({
            zIndex: "1004",
            mLeft: "10"
...
function LanDetect() {
    ...
    this.TOTAL_DETECT_TIME = 3;
    this.detectTime = 0;
    this.lanDetectHandle = function(a) {
        !1 == $.result.timeout && !1 == this.lanDetectSuccess && (this.detectTime++, this.detectTime >= TOTAL_DETECT_TIME && (this.lanDetectSuccess = !0, 
        this.detectTime = 0, clearTimeout(this.lanDetectTimeHd), a()));
    };
...
function ProgressBar() {
    ...
    this.initProgBar = function() {
        var a = id("ProgressBar"), c, b, d;
        null == a && (a = document.createElement("div"), a.id = "ProgressBar", document.body.appendChild(a), 
        c = document.createElement("div"), c.className = "progressBarCon", a.appendChild(c), 
        b = document.createElement("div"), b.className = "progressBarPCon", c.appendChild(b), 
        d = document.createElement("p"), d.className = "progressBarPercent", b.appendChild(d), 
        b = document.createElement("div"), b.className = "progressBarBg", c.appendChild(b), 
        d = document.createElement("p"), d.className = "progressBarDe", b.appendChild(d), 
        d = document.createElement("p"), d.className = "progressBarDes", c.appendChild(d));
        this.progressBar = a;
        this.progressDeWidth = 0;
    };
    this.progRunning = function(a, c, b) {
        var d = $("div.progressBarBg"), e = $("p.progressBarDe"), f = $("p.progressBarPercent"), g = this.progressDeWidth + 2, h = parseInt(d.css("width")) - g - parseInt(e.css("paddingRight")), k = c / 100, l = 0, m = this;
        e.css("width", g + "px");
        h = parseFloat(h / 100);
        (function() {
            100 < l ? void 0 != b && b() : (!0 == a && (f[0].innerHTML = l + "%"), e.css("width", g + h * l + "px"), 
            l++, m.progressBarHd = $.setTimeout(arguments.callee, k));
        })();
    };
    this.showProgBar = function(a, c, b, d, e) {
        this.showCover(function() {
            this.initProgBar();
            ...
            if (void 0 != e) {
                var f = id("ProgressBar").childNodes[0];
                p = id("progressBarTip");
                void 0 == p && (p = document.createElement("p"), p.id = "progressBarTip", p.className = "progressBarTip");
                f.appendChild(p);
            } else p = id("progressBarTip"), void 0 != p && (p.innerHTML = "");
            d = void 0 == d ? !0 : d;
            $("div.progressBarPCon").css("visibility", !0 == d ? "visible" : "hidden");
            $("p.progressBarDes")[0].innerHTML = c;
            void 0 != e && (p.innerHTML = e);
    ...
    this.progRunningP = function(a, c, b, d) {
        function e(c) {
            q = parseInt(c.count);
            s = c[ERR_CODE];
            ERR_PERCENT == q ? (v.closeProgBar(), "function" == typeof b && b(!1, s)) : (!0 == a && !1 == isNaN(q) && (100 <= q && (q = 100), 
            h[0].innerHTML = q + "%"), l.css("width", m + n * q + "px"), 100 <= q ? "function" == typeof b && b(!0) : v.progressBarHd = $.setTimeout(f, d));
        }
        function f() {
            "function" == typeof c && c(e);
        }
        var g = this.progressBar, h = $(g).find("p.progressBarPercent"), k = $(g).find("div.progressBarBg"), l = $(g).find("p.progressBarDe"), m = this.progressDeWidth + 2, n = parseInt(k.css("width")) - m - parseInt(l.css("paddingRight")), q = 0, s = ENONE, v = this;
        l.css("width", m + "px");
        n = parseFloat(n / 100);
        f();
    };
    this.showProgBarP = function(a, c, b, d) {
        this.showCover(function() {
            ...
            var e = id("progressBarTip");
            void 0 != e && (e.innerHTML = "");
...
function BlockGrid() {
    ...
    "function" != typeof BlockGrid.prototype.blockInit && (BlockGrid.prototype.blockInit = function(a) {
        ...
        var c, b;
        for (b in a) if (c = a[b], "undefined" != typeof this._ops[b]) if ("object" != typeof c || c instanceof Array || null == this._ops[b]) this._ops[b] = c; else for (var d in c) this._ops[b][d] = c[d];
    }, BlockGrid.prototype.create = function() {
        var a, c;
        this.con = id(this._ops.id);
        emptyNodes(this.con);
        for (var b = 0; b < this._ops.dataInfo.length; b++) {
            var d = this._ops.dataInfo[b], e = this._ops.data[b];
            a = document.createElement("li");
            a.onclick = function() {
                var a = $(this).find("i")[0], b = a.style.visibility;
        ...
        for (var a = $("#" + this._ops.id).find("i"), c = [], b, d = 0; d < a.length; d++) b = this._ops.dataInfo[d], 
        b = "visible" == a[d].style.visibility ? b.value : b.unValue, c.push(b);
        return c;
    });
}
...
function TimeControlSet() {
    ...
    this.netCtrlListCreate = function(a, c, b, d, e, f) {
        var g = id("netControlList"), h, k, l, m = document, n, q, s, v = 0, w = uciHostsInfo.optName.name, t = uciHostsInfo.optName.startTime, u = uciHostsInfo.optName.endTime, z = [ label.Mon, label.Tue, label.Wen, label.Thu, label.Fri, label.Sta, label.Sun ];
        emptyNodes(g);
        ...
        for (var x in a) {
            var r = "";
            v++;
            for (var y in a[x]) s = y, n = a[x][y];
            k = m.createElement("li");
            $(k).hover(function() {
            ...
            h.appendChild(k);
            l = m.createElement("i");
            l.onclick = function(a, b) {
                return function() {
                    c(a, b);
                };
            }(s, a);
            k.appendChild(l);
            k.onclick = !0 == e ? function(a, c, g) {
                return function(h) {
                    h = h || window.event;
                    if (c != (h.target || h.srcElement)) {
                        h = a[w];
                        var k = a[t], l = a[u];
                        ...
                        gTimeLimitKeyName = g;
                        q = objToWeekList(a);
                        setNetControlPanel(h, k, l, q, b, d, e, f);
                        netControlPanelDis(!0);
                        beEdit = !0;
                    }
                };
            }(n, l, s) : null;
            l = m.createElement("pre");
            l.innerHTML = htmlEscape(getStrInMax(n[w], 16));
            k.appendChild(l);
            l = m.createElement("span");
            l.innerHTML = !0 == e ? n[t] + label.wlanOn + " / " + n[u] + label.wlanOff : label.limitTime + label.colon + n[t] + " - " + n[u];
            k.appendChild(l);
            l = m.createElement("span");
            q = objToWeekList(n);
            for (var C in q) q[C] == ENABLED && (r += z[C] + label.sep);
            0 < r.length && (r = r.substring(0, r.length - 1));
            l.innerHTML = label.repeat + label.colon + r;
            k.appendChild(l);
        }
        g.num = v;
    };
    this.objToWeekList = function(a) {
        var c = [], b = [ uciHostsInfo.optName.mon, uciHostsInfo.optName.tue, uciHostsInfo.optName.wed, uciHostsInfo.optName.thu, uciHostsInfo.optName.fri, uciHostsInfo.optName.sat, uciHostsInfo.optName.sun ], d;
        for (d in b) a[b[d]] == ENABLED ? c.push(ENABLED) : c.push(DISABLED);
        return c;
    };
    this.weekListToObj = function(a, c) {
        var b = [ uciHostsInfo.optName.mon, uciHostsInfo.optName.tue, uciHostsInfo.optName.wed, uciHostsInfo.optName.thu, uciHostsInfo.optName.fri, uciHostsInfo.optName.sat, uciHostsInfo.optName.sun ], d;
    ...
    this.setNetControlPanel = function(a, c, b, d, e, f, g, h) {
        var k = c.split(":");
        c = b.split(":");
        b = k[0];
        var k = k[1], l = c[0];
        c = c[1];
        netControlPanelInit(e, f, g, h);
        id("netControlName").value = a;
        id("beginHour").changeSel(b);
        id("beginMinute").changeSel(k);
        id("endHour").changeSel(l);
...
function Slp() {
    ...
    this.calcNextIndex = function(a, c) {
        ...
        for (d in a) {
            var e = a[d][".name"];
            "undefined" != typeof e && "string" == typeof e && (e = e.replace(/^.*_(\d+)$/g, "$1"), 
            b[e] = !0);
        }
        e = b.length;
...
function CloudCommon() {
    ...
    this.cloudPageSetNodes = function(a) {
        var c = "none", b = "none", d, e = document.body.childNodes;
        !0 == a ? (b = "block", c = "none", gCloudAccountBR.bodyHeight = parseInt(document.body.offsetHeight), 
        document.body.style.height = "auto") : (b = "none", c = "block", document.body.style.height = gCloudAccountBR.bodyHeight + "px");
        for (var f in e) d = e[f], void 0 != d.nodeName && "DIV" == d.nodeName.toUpperCase() && (d.id == this.cloudPageId ? setStyle(d, {
            display: b
        }) : "Con" == d.id ? !0 == a ? (d.style.visibility = "hidden", d.style.position = "absolute", 
        d.style.top = "-9999px") : (d.style.visibility = "visible", d.style.position = "static", 
        d.style.top = "0px") : d.id == this.loginId && d.id == this.coverId || setStyle(d, {
            display: c
        }));
        id(this.loginId).style.display = "none";
        id(this.coverId).style.display = "none";
    };
    this.appendErrCode = function(a, c) {
        return a + label.lBrackets + errStr.errCode + label.colon + parseInt(c) + label.rBrackets;
    };
...
function CloudAction() {
    ...
    this._cloudGetActnErrHandle = function(a, c) {
        ...
        switch (parseInt(a)) {
          ...
          case EINVILLEGALDEVICE:
            b = appendErrCode(label.cloudDeviceInfoExpt, a);
            break;
    ...
    this._cloudAccountStatus = function(a, c, b) {
        ...
        $.query(_cloudStatusDataOrg(a), function(d) {
            if (_cloudGetActnErrHandle(d[ERR_CODE])) {
                var e = cloudClientStatus, f = parseInt(d[e.fileName][a][e.optName.actionStatus]), e = e.optValue.queryStatus;
                switch (f) {
                  case e.idle:
                  case e.max:
    ...
    this._cloudActionQueryStatus = function(a, c, b, d, e) {
        !0 != cloudActionQueryStoped && (!0 == cloudActionStatusQuering && !1 == b ? _cloudGetActnErrHandle(EINVLASTOPTIONISNOTFINISHED) : (cloudActionStatusQuering = !1, 
        clearTimeout(cloudActionQueryStatusHd), clearTimeout(cloudActionQueryStatusWaitHd), 
        ...
        $.action(b, function(a) {
            if (!0 != cloudActionQueryStoped && !0 == _cloudGetActnErrHandle(a[ERR_CODE], c)) {
                ...
                _cloudActionQueryStatus(b.secName.getAccountStat, function(a) {
                    _cloudQueryErrHandle(a[b.fileName][b.secName.getAccountStat][b.optName.errCode]) && (a = {}, 
                    a[d.fileName] = {}, a[d.fileName][KEY_NAME] = d.secName.deviceStatus, $.action(a, function(a) {
...
function CloudUpgradePush() {
    ...
    this.errHandleCloudPush = function(a) {
        switch (a) {
          ...
          case EINVERRORDEVICEIDFORMATERROR:
          case EINVILLEGALDEVICE:
            gOnlineUpgradeNote = appendErrCode(label.cloudDeviceInfoExpt, a);
            break;
    ...
    this.upgradeFailHdCloudPush = function() {
        "function" == typeof this.upgradeErrCBCloudPush && (this.upgradeErrCBCloudPush(), 
        this.upgradeErrCBCloudPush = null);
    };
    this.checkOnlineUpgrading = function(a) {
        var c = cloudClientStatus.fileName, b = {};
        b[c] = {};
        b[c][KEY_NAME] = cloudClientStatus.secName.clientInfo;
        !0 == $.local ? a() : $.query(b, function(b) {
            ENONE == b[ERR_CODE] ? (b = parseInt(b[c][cloudClientStatus.secName.clientInfo][cloudClientStatus.optName.fwDownloadStatus]), 
            uciCloudConfig.optValue.cloudDownloading == b ? onlineUpgradeProgress(SYSUPGRADE_SECONDS) : a()) : a();
        });
    };
    this.onlineUpgradeProgress = function(a) {
        var c = cloudClientStatus.fileName;
        showProgBarP(statusStr.fwDownloading, function(a) {
            var d = {}, e = {};
            d[c] = {};
            d[c][KEY_NAME] = cloudClientStatus.secName.clientInfo;
            $.query(d, function(d) {
                if (!0 == errHandleCloudPush(d[ERR_CODE])) {
                    d = d[c][cloudClientStatus.secName.clientInfo];
                    var g = parseInt(d[cloudClientStatus.optName.fwDownloadStatus]);
                    e.count = uciCloudConfig.optValue.cloudDownloading == g || uciCloudConfig.optValue.cloudComplete == g ? parseInt(d[cloudClientStatus.optName.fwDownloadProgress]) : uciCloudConfig.optValue.cloudOutline == g ? ERR_PERCENT : 0;
                } else e.count = ERR_PERCENT;
                e[ERR_CODE] = ENONE;
                a(e);
            }, !0);
        }, !0, function(b) {
            closeProgBar();
            !0 == b ? showProgBar(a, label.upgrading, function() {
    ...
    this.checkFWVerSuccessCloudPush = function() {
        var a = uciCloudConfig.fileName, c = {};
        c[a] = {};
        c[a][uciCloudConfig.actionName.downloadFw] = null;
        $.action(c, function(a) {
            !0 == errHandleCloudPush(a[ERR_CODE]) && (a = a.wait_time ? 1e3 * parseInt(a.wait_time) : SYSUPGRADE_SECONDS, 
    ...
    this.onlineUpgradeCheck = function(a, c, b) {
        ...
        var e = uciCloudConfig.fileName, f = cloudClientStatus.fileName, g = {};
        g[e] = {};
...
function Phone() {
    this.OS = {
        ...
        checkDeviceMode: function() {
            ...
            if (void 0 != a) if (0 <= a.indexOf("Win")) 0 <= c.indexOf("Windows Phone") ? this.portable = this.windows = this.windowsPhone = !0 : (this.windows = !0, 
            this.portable = !1); else if (0 <= c.indexOf("NOKIA")) this.portable = this.nokia = !0; else if (0 <= c.indexOf("Android")) this.portable = this.android = !0; else if (0 <= a.indexOf("iPad")) this.portable = this.iPad = !0; else if (0 <= a.indexOf("iPhone")) this.portable = this.iPhone = !0; else if (0 <= a.indexOf("iPod")) this.portable = this.iPod = !0; else if (0 <= c.indexOf("Wii") || 0 <= c.indexOf("PLASTATION")) this.portable = this.player = !0; else if (0 <= a.indexOf("Mac")) this.iMacPC = !0, 
            this.portable = !1; else {
                if (0 <= a.indexOf("X11") || 0 <= a.indexOf("Linux") && 0 > a.indexOf("arm")) this.unixPC = !0, 
                this.portable = !1;
